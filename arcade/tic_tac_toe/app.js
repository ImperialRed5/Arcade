//This code is copied directly from the arcade workshop. I am using it as a visual starting point for my tic tac toe game.
const gameState = {
    players: ['x', 'o'],
    board: [
      [null, null, null],
...
function tick() {
  ...
  //need to write code for tic tac toe game
